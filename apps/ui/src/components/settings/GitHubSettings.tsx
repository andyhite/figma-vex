...
interface GitHubSettingsProps {
  ...
  initialToken?: string;
  onSettingsChange?: (settings: { githubRepository: string; githubToken: string }) => void;
}
...
export function GitHubSettings({
  ...
  const persistSettings = useCallback(
    (updates: Partial<{ repository: string; token: string }>) => {
    ...
    [repository, token, onSettingsChange]
  );
